...
VERSION_FILE="streambird/_version.py"
...
then
    ...
    if [[ -z "${STREAMBIRD_TEST_API_KEY}" ]]; then
        echo "Test key not found. Please assign 'STREAMBIRD_TEST_API_KEY=...' as your test environment key."
        exit 1
    fi
