...
class Api:
    ...
    def __init__(self, api_key, user_agent_extension=None, api_instance_url=None):
        if api_key == "" or api_key is None:
            raise StreambirdException("Please provide a valid API Key.")
        ...
        self.base_api_url = api_instance_url or STREAMBIRD_API_BASE_URL_V1
    ...
    def _http_request(
        ...
        try:
            ...
            raise StreambirdException(err) from err
    ...
    def _raise_on_respose(res: Response):
        ...
        exception = ExceptionMap.get(res.status_code, StreambirdException)
